...
<head>
  ...
  <!-- CSS Libraries -->
<?php
if ($this->uri->segment(2) == "" || $this->uri->segment(2) == "login") { ?>
...
if ($this->uri->segment(2) == "layout_transparent") {
  $this->load->view('data/partials/layout-2');
  $this->load->view('data/partials/sidebar-2');
}elseif ($this->uri->segment(2) == "layout_top_navigation") {
  $this->load->view('data/partials/layout-3');
  $this->load->view('data/partials/navbar');
  ...
  $this->load->view('data/partials/layout');
  $this->load->view('data/partials/sidebar');
}
?>
